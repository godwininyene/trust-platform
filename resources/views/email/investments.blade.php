                                ...
                                <tr>
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            ...
                                            <p>
                                                You have successfully invested <b>${{ number_format($mining->amount,2) }}</b> on our "{{ $plan->name }}" investment module.
                                            </p>
                                            <p>
                                                Kindly wait for the stipulated time of {{ $plan->mining_duration }} {{ $plan->timing_parameter }} and your profits will 
